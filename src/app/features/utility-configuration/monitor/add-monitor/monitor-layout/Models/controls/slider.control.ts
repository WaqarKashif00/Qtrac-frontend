...
import { IMonitorSliderControlPostPreview } from '../monitor-slider-control-preview.interface';
import { Control } from './control';

export class SliderControl extends Control {
  src: Array<IMonitorSliderControlPostPreview>;
  urls: Array<IMonitorSliderControlPostPreview>;
  uniqueName: string;
  selected: boolean;
  constructor(
