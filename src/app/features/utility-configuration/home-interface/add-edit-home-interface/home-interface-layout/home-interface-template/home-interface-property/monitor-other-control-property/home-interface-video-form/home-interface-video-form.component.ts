...
@Component({
  selector: 'lavi-home-interface-video-form',
  templateUrl: './home-interface-video-form.component.html',
  styleUrls: ['./../home-interface-other-control.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class HomeInterfaceVideoFormComponent extends AbstractComponent {
  @Input() Item: VideoControl;
  FileName: string;
  VideoFormArray$: Observable<FormArray>;
  Open = false;

  constructor(private monitorPropertyService: HomeInterfacePropertyService,
