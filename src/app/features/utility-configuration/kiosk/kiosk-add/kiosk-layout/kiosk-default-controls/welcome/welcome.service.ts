...
export class WelcomeService extends AbstractComponentService {
  ...
  WelcomeControlSelectedSubject: BehaviorSubject<IControlSelection>;
  ...
  SubscribeSubject() {
    ...
    this.subs.sink = this.layoutService.WelcomePage$.subscribe((x) => {
      this.Buttons = x.buttons;
      this.ButtonsSubject.next(x.buttons);
      this.WelcomeControlSelectedSubject.next(cloneObject(x.controlSelection))
    });
  ...
  private InitializeSubjects() {
    ...
    this.WelcomeControlSelectedSubject = new BehaviorSubject<IControlSelection>(
      null
    );
    this.WelcomePageControlSelected$ =
      this.WelcomeControlSelectedSubject.asObservable();
  ...
  ButtonResizeStop(event: IResizeEvent, name: string) {
    this.layoutService.OnWelcomePageButtonSelection();
