...
@Component({
  selector: 'lavi-no-queue-button-control',
  templateUrl: './no-queue-button-control.component.html',
})
export class NoQueueButtonControlComponent extends AbstractComponent {
