...
@Injectable()
export class OffLineService extends AbstractComponentService {
  ...
  OffLineControlSelectedSubject: BehaviorSubject<IControlSelection>;
  ...
  SubscribeSubject() {
    ...
    this.subs.sink = this.layoutService.OffLinePage$.subscribe((x) => {
      this.Buttons = x.buttons;
      this.ButtonsSubject.next(x.buttons);
      this.OffLineControlSelectedSubject.next(cloneObject(x.controlSelection));
    });
  ...
  private InitializeSubjects() {
    ...
    this.OffLineControlSelectedSubject = new BehaviorSubject<IControlSelection>(
      null
    );
    this.OffLinePageControlSelected$ =
      this.OffLineControlSelectedSubject.asObservable();
  ...
  ButtonResizeStop(event: IResizeEvent, name: string) {
    this.layoutService.OnOffLinePageButtonSelection();
