...
@Component({
  selector: 'lavi-off-line-button-control',
  templateUrl: './off-line-button-control.component.html',
})
export class OffLineButtonControlComponent extends AbstractComponent {
